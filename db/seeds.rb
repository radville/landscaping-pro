...
l1 = Landscaper.create!(email: "happymowers23@gmail.com", password: "akjhhdkjhf", business_name: "Sarah's Happy Mowers", owner_name: "Sarah McMurdo", description: "We love mowing lawns!", zip_code: "01962")
l2 = Landscaper.create!(email: "landscap@gmail.com", password: "08fgjkhjshdkfs", business_name: "Restful Landscaping", owner_name: "Richard", description: "Providing complete landscaping services", zip_code: "22034")
l3 = Landscaper.create!(email: "mowmowmow@gmail.com", password: "08fgjkhjshdkfs", business_name: "Springfield Lawn Care", owner_name: "Henry Smith", zip_code: "55867")
...
u3 = User.create!(first_name: "Lauren", last_name: "Radcliff", address_1: "132 Main St.", city: "West Blueberry", state: "MA", zip_code: "01985", email: "radz@gmail.com", password: "0hhjhjfdhf")
